...
export SESSION_ID="cu-perception-p9b-external-task-invocation-physical-public-s06"
...
export TEST_SOURCE_SHA="582470a5e60dafef27164acf2dce835aecefffad"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p9b-pulsar-external-task-invocation-s06-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p9b-pulsar-external-task-invocation-s06-public"
