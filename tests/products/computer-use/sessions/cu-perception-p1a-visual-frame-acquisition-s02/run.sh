...
export SESSION_ID="cu-perception-p1a-visual-frame-acquisition-s02"
...
export TEST_SOURCE_SHA="f4f454f9d4837cf71412b6464a2a8184908512bc"
export CONTRACT_TESTS="tests/products/computer-use/external-computer-control-boundary-test.js tests/products/computer-use/visual-frame-acquisition-test.js tests/products/computer-use/perception-session-runner-test.js"
