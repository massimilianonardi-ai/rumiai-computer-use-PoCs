...
export SESSION_ID="cu-perception-p9b-external-task-invocation-child-diagnostic-public-s08"
...
export TEST_SOURCE_SHA="e5d16070afb4f6462ddef4c57f37ceb560d21afe"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p9b-pulsar-external-task-invocation-diagnostic-s08-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p9b-external-task-invocation-child-diagnostic-s08-public"
