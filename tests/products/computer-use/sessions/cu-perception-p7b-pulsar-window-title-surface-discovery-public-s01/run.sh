...
if /usr/bin/pgrep -x Pulsar >/dev/null 2>&1 || /usr/bin/pgrep -f '/Pulsar.app/Contents/MacOS/Pulsar' >/dev/null 2>&1; then
  ...
  echo "Pulsar is already running; close Pulsar before this physical discovery session so user editor state is not disturbed."
  exit 2
fi
export SESSION_ID="cu-perception-p7b-pulsar-window-title-surface-discovery-public-s01"
export EXPECTED_PRODUCT_SHA="99c058ad9c89e666b471b20aafe214dc5b339ce6"
export EXPECTED_CONTROL_SHA="e3a3f13d66546cf8f0fca50075bd4607c2c3d003"
export TEST_SOURCE_SHA="3d65df4db08dc5bf5f7d5a42c15f06e58cabee4f"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p7b-pulsar-window-title-surface-discovery-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p7b-pulsar-window-title-surface-discovery-public"
