...
export SESSION_ID="cu-perception-p6d-semantic-title-surface-precondition-public-s10"
export EXPECTED_PRODUCT_SHA="a90ab782d85e1283e76b4b64aa9bdbe54a7e4e0e"
export EXPECTED_CONTROL_SHA="e3a3f13d66546cf8f0fca50075bd4607c2c3d003"
export TEST_SOURCE_SHA="d5b6d9561b98409d52a84f4c1a45aa59de489357"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p6d-semantic-title-surface-precondition-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p6d-semantic-title-surface-precondition-public"
