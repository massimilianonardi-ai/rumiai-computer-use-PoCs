...
export SESSION_ID="cu-perception-p9b-external-task-invocation-semantic-cleanup-diagnostic-public-s13"
...
export TEST_SOURCE_SHA="e9cf9bf85942c6a47d8c546f4a8c3d43d1f9c4ee"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p9b-pulsar-external-task-invocation-cleanup-diagnostic-s13-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p9b-external-task-invocation-semantic-cleanup-diagnostic-s13-public"
