...
if /usr/bin/pgrep -x Safari >/dev/null 2>&1; then
  ...
  echo "Safari is already running; close Safari before this test so user browser state is not disturbed."
  exit 2
fi
export SESSION_ID="cu-perception-p6d-surface-precondition-public-s01"
export EXPECTED_PRODUCT_SHA="7cb236f4d9af6ed72b1ec0857276fc7050fdcec7"
export EXPECTED_CONTROL_SHA="e3a3f13d66546cf8f0fca50075bd4607c2c3d003"
export TEST_SOURCE_SHA="15c06fe284c487d399957bc068b757bbb97198ed"
