...
export SESSION_ID="cu-perception-p9b-external-task-invocation-physical-public-s03"
...
export TEST_SOURCE_SHA="f4aa97e3783593a129b8206e1d7955f44ab2cae2"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p9b-pulsar-external-task-invocation-s03-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p9b-pulsar-external-task-invocation-s03-public"
