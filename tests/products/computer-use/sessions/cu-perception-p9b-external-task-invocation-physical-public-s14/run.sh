...
export SESSION_ID="cu-perception-p9b-external-task-invocation-physical-public-s14"
...
export TEST_SOURCE_SHA="75643c0e0ecd1badd992bbfc337f79ac6c81abfa"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p9b-pulsar-external-task-invocation-s14-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p9b-pulsar-external-task-invocation-s14-public"
