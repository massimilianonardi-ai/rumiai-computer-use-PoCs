...
export SESSION_ID="cu-perception-p9b-external-task-invocation-physical-public-s11"
...
export TEST_SOURCE_SHA="7fabbd493b23122ff1a44f36b89d7fa4c9ca7cae"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p9b-pulsar-external-task-invocation-s11-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p9b-pulsar-external-task-invocation-s11-public"
