...
export SESSION_ID="cu-perception-p9b-external-task-invocation-physical-public-s09"
...
export TEST_SOURCE_SHA="aecac78f8e822382f6a10bff64c2b57a14c362fe"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p9b-pulsar-external-task-invocation-s09-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p9b-pulsar-external-task-invocation-s09-public"
