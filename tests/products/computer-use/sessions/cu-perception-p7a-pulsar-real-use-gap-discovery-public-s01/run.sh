...
export SESSION_ID="cu-perception-p7a-pulsar-real-use-gap-discovery-public-s01"
...
export TEST_SOURCE_SHA="9ae06dc1c81cf587b880dd47de84e3b87d97ea9e"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p7a-pulsar-real-use-gap-discovery-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p7a-pulsar-real-use-gap-discovery-public"
