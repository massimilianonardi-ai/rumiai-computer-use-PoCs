...
export SESSION_ID="cu-perception-p9b-external-task-invocation-diagnostic-public-s02"
...
export TEST_SOURCE_SHA="7827a82ba0de08d265c657441e306bd05c9fe8c0"
...
export PHYSICAL_TEST="tests/products/computer-use/physical-tests/perception-p9b-external-task-invocation-diagnostic-public.js"
export PHYSICAL_TEST_ID="physical:computer-use-perception-p9b-external-task-invocation-diagnostic-public"
