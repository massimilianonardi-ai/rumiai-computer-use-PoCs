...
test("native ui.find translates canonical radio-button to the agent-ctrl radio role", () => {
  assert.equal(operations.agentCtrlFindRole("radio-button"), "radio");
  assert.equal(operations.agentCtrlFindRole("checkbox"), "checkbox");
  assert.equal(operations.agentCtrlFindRole(null), null);
});
